...
@section('main-content')
    ...
    <section class="small-banner section">
        <div class="container-fluid">
            <div class="row">
                ...
                {{--            @endphp--}}
                @php
                    use App\Models\Category;use App\Models\Product;use App\Models\ProductReview;

                    $category_lists = Category::where('status', 'active')->limit(3)->get();
                @endphp
    ...
    ->orderBy('_id', 'DESC')  // Use '_id' for recent documents
    ->limit(6)
    ->get();
                        @endphp
                        @foreach($product_lists as $product)
